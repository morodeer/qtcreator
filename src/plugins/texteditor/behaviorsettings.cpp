...
static const char smoothScroll[] = "SmoothScroll";
...
void BehaviorSettings::toMap(const QString &prefix, QVariantMap *map) const
{
    ...
    map->insert(prefix + QLatin1String(smoothScroll), m_smoothScroll);
...
void BehaviorSettings::fromMap(const QString &prefix, const QVariantMap &map)
{
    ...
    m_smoothScroll =
        map.value(prefix + QLatin1String(smoothScroll), m_smoothScroll).toBool();
    m_keyboardTooltips =
